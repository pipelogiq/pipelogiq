...
[![Status: Preview v0.3.1-preview.3](https://img.shields.io/badge/status-Preview%20v0.3.1--preview.3-orange)](CHANGELOG.md)

> **Preview (v0.3.1-preview.3).** Breaking changes may occur before v1.0.
...
```bash
PIPELOGIQ_VERSION=v0.3.1-preview.3 docker compose -f infra/compose/docker-compose.registry.yml up -d
```
